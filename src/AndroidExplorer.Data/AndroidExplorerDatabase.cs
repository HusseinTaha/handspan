...
public interface IAndroidExplorerDatabase
{
...
/// </remarks>
public sealed class AndroidExplorerDatabase(string databasePath, ILogger<AndroidExplorerDatabase> logger)
    : IAndroidExplorerDatabase
{
